...
// procedure exportar_todos_empleados(var archivo:empleados); COMPLETAR!!!


//estara bien esto??
procedure borrar_empleado(var archivo:empleados; pos:integer);
var
	reg_empleado : empleado;
	reg_empleado_eliminar: empleado;
begin
	reset(archivo);
	seek(archivo, filesize(archivo));
	read(archivo,reg_empleado);
	seek(archivo,pos);
	read(archivo,reg_empleado_eliminar);
	seek(archivo,filepos(archivo)-1);
	write(archivo,reg_empleado);
	seek(archivo, filesize(archivo));
	write(archivo, reg_empleado_eliminar);
end;
